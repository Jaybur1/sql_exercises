-- uses the "world" table from https://sqlzoo.net/wiki/SELECT_from_WORLD_Tutorial
...
SELECT
  name,
  gdp / population AS perr_capita_gdp
FROM
  world
WHERE
  population >= 200000000 
...
SELECT
  name,
  population / 1000000 as population_in_milions
FROM
  world
WHERE
