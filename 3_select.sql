-- usese nobel table from https://sqlzoo.net/wiki/SELECT_from_Nobel_Tutorial
...
FROM 
  nobel
WHERE 
  yr = 1984 ORDER BY subject IN ('Physics','Chemistry'), subject, winner;